    ...
    const getProductById = (id) => {
        $.ajax({
            ...
            success: function(response) {
                ...
                let listForm = product.skus.map((sku, index) => {
                  let attr = sku.sizes.map((size, i) => {
                    return `<div class="row">
                            ...
                            ${i === 0 ?
                              `
                                <select name="color" class="form-select">
                                  ...
                                  <option value="red" ${sku.color === 'red' && 'selected'}>Đỏ</option>
                                  <option value="blue" ${sku.color === 'blue' && 'selected'}>Xanh biển</option>
                                  <option value="cyan" ${sku.color === 'cyan' && 'selected'}>Lục lam</option>
                                  <option value="green" ${sku.color === 'green' && 'selected'}>Xanh lá</option>
                                  <option value="yellow" ${sku.color === 'yellow' && 'selected'}>Vàng</option>
                                  <option value="violet" ${sku.color === 'violet' && 'selected'}>Tím</option>
                                  <option value="black" ${sku.color === 'black' && 'selected'}>Đen</option>
                                  <option value="white" ${sku.color === 'white' && 'selected'}>Trắng</option>
                                </select>
                              ` : ''
                            }
                          </div>
                          <div class="col-8">
                            <div class="row">
                              ...
                              <div class="col mb-4">
                                <input value="${sku.quantity[index]}" type="number" class="form-control" id="ecommerce-product-discount-price" placeholder="Số lượng" name="quantity" aria-label="Product Quantity" />
                              </div>
                              <div class="col mb-4">
                                <input value="${sku.prices[index]}" type="number" class="form-control" id="ecommerce-product-discount-price" placeholder="Giá" name="prices" aria-label="Product Giá" />
                              </div>
                              <div class="col-1 mb-4">
                                ${i === 0 ? 
                                  `
