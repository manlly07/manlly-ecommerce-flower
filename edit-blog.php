...
<body>
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              <div class="form-floating form-floating-outline mb-4">
                ...
                <label for="ecommerce-product-name">Tên blog</label>
              </div>
              <div class="form-floating form-floating-outline mb-4">
                <input type="text" class="form-control" id="ecommerce-product-description" placeholder="Product description" name="productDescription" aria-label="Product Description" pattern="/^(?!\s*$).+/" />
                <label for="ecommerce-product-description">Mô tả ngắn gọn</label>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                <form class="dropzone needsclick dz-clickable col-12" id="dropzone-basic">
                  <div class="dz-message needsclick my-5">
                    ...
                    <p class="mt-4 pt-4 ">Kéo hoặc thả ảnh blog vào đây</p>
                  </div>
  ...
  <script>
    ...
    $(document).on('click', '.submitForm', function() {
      ...
      var product_description = $('#ecommerce-product-description').val();
    ...
    const getBlogById = (id) => {
        $.ajax({
            ...
            success: function(response) {
                ...
                console.log(blog);
                $('#ecommerce-product-name').val(blog.title);
                $('#ecommerce-product-description').val(blog.description);
                tinymce.init({
                    selector: 'textarea#default',
                    placeholder: 'Mô tả sản phẩm ...',
                    highlight_on_focus: true,
